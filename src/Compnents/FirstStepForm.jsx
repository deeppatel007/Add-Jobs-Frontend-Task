        ...
        <div class="bg-white shadow-md rounded-10 px-8 py-8 h-141 w-145 ">
            ...
            <div class="text-xl">
              ...
              <div class="grid gap-6 md:grid-cols-2 pt-6">
                <div>
                  <label class="pb-1 font-normal block text-sm font-medium text-gray-900 ">Location</label>
                ...
                <div>
                  <label class="pb-1 block text-sm font-medium text-gray-900 ">Remote Type</label>
